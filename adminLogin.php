...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      echo("<script type='text/javascript'> alert('login Successfully!!'); window.location='finale/insert.php';</script>");
   }else{
...
<div id="cursor"></div>
  <div id="nav">
    ...
    <h4>मुख्यपृष्ठ</h4>
    <h4>आमच्याबद्दल</h4>
    <h4 id="login-btn">प्रशासक लॉगिन</h4>
  ...
  <div class="login-form-container">
    ...
    <form action="" method="post">
      <h3 id="title">प्रशासक लॉगिन</h3>
      <div class="input-field" id="emailField">
        <input type="text" name = "email" class="box" placeholder="तुमचा ईमेल टाका">
